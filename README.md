...
Demo of creating a Password field from a Textbox.

## Install 

Not required.  Simply open the project.

You will find the javascript file in the scripts folder.  This is called in the textbox's .onAttached event.  
